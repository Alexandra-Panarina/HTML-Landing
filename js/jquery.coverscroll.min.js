(function (c) {
    ...
    var a = {
        init: function (f) {
            ...
            function d(k, o, v) {
                var w = c(o.get(v));
                var s = (k.height() > 250) ? 360 : k.height();
                var p = {
                    width: s,
                    height: s+140,
                    top: 0,
                ...
                for (i = v - 1; i >= 0; i--) {
                    ...
                    if (r >= 0 && q && t <= g.step.limit) {
                        ...
                        if (!sf) {
                            r = Math.round(r + (l / j) - u - g.step.width-50);
                            sf = true;
                            t++;
                            n.show()
                        } else {
                    ...
                    var p = {
                        width: l,
                        height: l,
                        top: Math.round(k.height() / g.bendamount - l / g.bendamount+50),
                        left: r
                    };
                    if (c.browser.msie) {
                        h = true;
                ...
                for (i = v + 1; i < o.length; i++) {
                    ...
                    if ((r + l) < k.width() && q && t <= g.step.limit) {
                        ...
                        if (!sf) {
                            sf = true;
                            t++;
                            r = Math.round((r - l / j) + g.step.width + u + 60);
                            n.show()
                        } else {
                            n.hide();
                            q = false
            ...
            function e(l, m, j) {
                m = c(m);
                var o = (l.outerHeight() > 250) ? 300 : l.outerHeight();
                var n = false;
                if (n = m.attr("title")) {
